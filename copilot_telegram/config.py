...
def load_startup_config() -> StartupConfig:
    ...
    return StartupConfig(
        ...
        binary_download_max_bytes=read_env_int(
            "COPILOT_BINARY_DOWNLOAD_MAX_BYTES",
            DEFAULT_BINARY_DOWNLOAD_MAX_BYTES,
        ),
        binary_download_timeout_seconds=read_env_int(
            "COPILOT_BINARY_DOWNLOAD_TIMEOUT_SECONDS",
            DEFAULT_BINARY_DOWNLOAD_TIMEOUT_SECONDS,
        ),
        skill_tool_max_calls_per_ask=max(
            1,
            read_env_int(
